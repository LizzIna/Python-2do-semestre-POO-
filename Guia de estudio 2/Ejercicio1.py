class Sistema_de_venta:
    ...
    #calcular el total de una venta considerando el descuento de grupo
    @staticmethod
    def calcular_total(precio, cantidad, aplicar_descuento=False):
        total = precio * cantidad
        if aplicar_descuento:
            total *= (1 - Sistema_de_venta.descuento_grupo)
        return total
    ...
    def calcular_ingresos_totales(self):
        ...
        for tipo, cantidad in self.__ventas:
            ...
            total_ingresos += Sistema_de_venta.calcular_total(precio, cantidad, cantidad > 5)  #Descuento por más de 5 tickets
...
class Gimnasio:
    ...
    # Método estático para calcular el costo final con descuento de bienvenida
    @staticmethod
    ...
    # Método para aplicar descuento en suscripción anual
    def aplicar_descuento_anual(self):
        if self.__tipo_suscripcion == "anual":
            self.__costo *= (1 - Gimnasio.descuento_anual)

# Crear el sistema de venta de tickets
sistema = Sistema_de_venta()
...
# Calcular ingresos totales con descuento por más de 5 tickets en la venta VIP
ingresos_totales = sistema.calcular_ingresos_totales()
print(f"Ingresos totales: ${ingresos_totales:.2f}")

# Crear un gimnasio con suscripción mensual
